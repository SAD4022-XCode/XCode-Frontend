...
export const createEventValidationSchema = yup.object().shape({
    eventName: yup.string().min(3,"نام رویداد حداقل شامل 3 کاراکتر باید باشد").max(50,"نام رویداد حداکثر شامل 50 کاراکتر باید باشد").required("یک نام برای رویداد انتخاب کنید"),
    ...
    eventDescription: yup.string().min(20,"توضیحات حداقل باید 20 کاراکتر باشد").max(1000,"توضیحات حداکثر می تواند شامل 1000 کاراکتر باشد").required("لطفا در مورد جزئیات رویداد خود بنویسید"),
