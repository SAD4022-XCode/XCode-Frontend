...
const CityList = ({ selectedProvince, setSelectedProvince,selectedCity,setSelectedCity }) => {
    const provinces = [
        ...
        {name: "البرز", cities:["هشتگرد-ساوجبلاغ","نظرآباد","مشکین دشت","ماهدشت","گرمدره","کوهسار-چندار","کمال شهر","کرج","طالقان","شهر جدید هشتگرد","سیف آباد","چهارباغ","آسارا","اشتهارد","لطفا شهر را انتخاب کنید"]},
    ];
