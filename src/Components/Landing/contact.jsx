...
export const Contact = (props) => {
  ...
  return (
    <div>
      <div id="contact">
        <div className="container text-right mr-xl-5 mr-md-5">
          <div className="row ">
          <div className="col-md-8 mr-xl-5 mr-md-5">
            <div className="row w-100 mr-xl-5">
              <div className="section-title">
                <h2>ارتباط با ما</h2>
                <p>
                لطفا فرم زیر را پر کنید تا به ما ایمیل بفرستید و ما در اسرع وقت با شما تماس خواهیم گرفت.
                </p>
              </div>
          ...
          <div className="col-md-3 contact-info text-right">
